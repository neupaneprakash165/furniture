          ...
          <div className="col-md-6">
            <form id="contact-form" name="contact-form" onSubmit={handleSubmit} className="shadow p-4 rounded">
              <div className="row">
                ...
                <div className="col-md-12">
                  <div className="mb-3">
                    <input type="text" id="subject" name="subject" className="form-control" value={formData.subject} onChange={handleChange} placeholder="Subject" required />
                  </div>
                </div>
                <div className="col-md-12">
                  <div className="mb-3">
                    <textarea type="text" id="message" name="message" rows="2" className="form-control" value={formData.message} onChange={handleChange} placeholder="Your message" required></textarea>
                  </div>
                </div>
              </div>
